...
void im2col(const dtype* in, const int channels, const int height, const int width,
	...
	//TODO: should be test
	bigbangmemset(out, 0, sizeof(dtype)*output_h*output_w*channels*kernel_h*kernel_w);
	dtype* out_p = out;
...
template void im2col<double>(const double* in, const int channels, const int height, const int width,
	const int kernel_h, const int kernel_w, const int padding_h, const int padding_w,
	const int stride_h, const int stride_w, const int dilation_h, const int dilation_w,
	double* out);
template void im2col<float>(const float* in, const int channels, const int height, const int width,
	const int kernel_h, const int kernel_w, const int padding_h, const int padding_w,
	const int stride_h, const int stride_w, const int dilation_h, const int dilation_w,
	float* out);
...
void col2im(const Dtype* data_col, const int channels,
	...
	Dtype* data_im) {
	bigbangmemset(data_im, 0, sizeof(Dtype) * width * height);
...
template
	void col2im<float>(const float* data_col, const int channels,
		const int height, const int width, const int kernel_h, const int kernel_w,
		const int pad_h, const int pad_w,
		const int stride_h, const int stride_w,
		const int dilation_h, const int dilation_w,
...
template
	void col2im<double>(const double* data_col, const int channels,
		const int height, const int width, const int kernel_h, const int kernel_w,
		const int pad_h, const int pad_w,
		const int stride_h, const int stride_w,
		const int dilation_h, const int dilation_w,
